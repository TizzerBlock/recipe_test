...
export default {
  ...
  methods: {
    addRecipeToDb: function () {
        console.log(this.fields.name, this.fields.email, this.fields.recipe_name, this.fields.recipe_position, this.fields.description, this.fields.message)
        axios.post('/api/recipe', {name: this.fields.name, email: this.fields.email, recipe_name: this.fields.recipe_name, recipe_position: this.fields.recipe_position, description: this.fields.description, message: this.fields.message})
            .then( res => {
              this.fields.name = ''
              this.fields.email = ''
              this.fields.recipe_name = ''
              this.fields.recipe_position = ''
