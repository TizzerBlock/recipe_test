...
<div>
  <form  class="postcard">
    ...
    <div class="form-row">
      <input  v-on:click.prevent="updateRecipeInDb"
    ...
    getRecipe() {
      axios.get('/api/recipe/' + this.$route.params.id)
        .then( res => {
          ...
          this.fields.recipe_name = res.data.recipe_name
          this.fields.recipe_position = res.data.recipe_position
          this.fields.description = res.data.description
          this.fields.message = res.data.message
          console.log(res);
        })
    },
    updateRecipeInDb() {
